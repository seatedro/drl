...
const (
	RateLimiter_Allow_FullMethodName = "/drl.v1.RateLimiter/Allow"
	RateLimiter_Reset_FullMethodName = "/drl.v1.RateLimiter/Reset"
)
...
var RateLimiter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "drl.v1.RateLimiter",
